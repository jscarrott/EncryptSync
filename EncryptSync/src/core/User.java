...
public class User {
	...
	public User(String nameIn, String in, String out){//initialise the user object with values for everything but the password key that needs extra specific method and checks whether the password check reference file exists.
		name = nameIn;
