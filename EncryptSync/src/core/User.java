...
public class User {
	 ...
	 * 
	 * @param passwordKey
	 *            This should equal the key generated by the PBE algorithm
	 *            usedto encrypt all the files need to be properly seasoned
	 * @param name
	...
	/**
	 * Initialize the user object with values for everything but the password
	 * key that needs extra specific method and checks whether the password
	 ...
	 */
	public void generatePasswordKey(String passwordInput) throws NoSuchAlgorithmException, IOException, InvalidKeySpecException {
