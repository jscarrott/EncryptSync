...
public class User {
	...
	User(String nameIn, String in, String out){//initialise the user object with values for everything but the password key that needs extra specific method
		name = nameIn;
	...
	public byte[] saltCheck() throws IOException, NoSuchAlgorithmException{//Checks if there is a salt file for the user and if not creates one the saves it to a unique file
